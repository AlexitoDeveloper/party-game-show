...
export const GAMES_CATALOG: GameDefinition[] = [
  // 1. ADIVINA LA CANCIÓN
  {
    ...
    scoringOptions: [
      { id: 'music_full', label: '⭐ Pleno (+2)', delta: 2, hitsDelta: 2, badge: '+2', color: 'amber', description: 'Cantante y canción (+2 pts)' },
      { id: 'music_singer', label: '🎤 Cantante (+1)', delta: 1, hitsDelta: 1, badge: '+1', color: 'emerald', description: 'Acierto de cantante (+1 pt)' },
      { id: 'music_song', label: '🎵 Canción (+1)', delta: 1, hitsDelta: 1, badge: '+1', color: 'blue', description: 'Acierto de canción (+1 pt)' },
      { id: 'music_miss', label: '❌ Fallo (-1)', delta: -1, hitsDelta: 0, badge: '-1', color: 'red', description: 'Fallo tras pulsar (-1 pt)' },
      { id: 'music_p1', label: '🥇 1.º en Canciones (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Equipo con más canciones acertadas' },
      { id: 'music_p2', label: '🥈 2.º en Canciones (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Segundo clasificado musical' },
      { id: 'music_p3', label: '🥉 3.º en Canciones (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Tercer clasificado musical' },
      { id: 'music_p4', label: '4.º / 5.º en Canciones (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Resto de participantes' },
    ],
  },
  ...
  // 2. PREGUNTAS TRIVIAL
  {
    ...
    scoringOptions: [
      { id: 'triv_hit', label: '✅ Acierto Directo (+2)', delta: 2, hitsDelta: 1, badge: '+2', color: 'emerald', description: 'Pregunta acertada (+2 pts)' },
      { id: 'triv_rebound', label: '↩️ Acierto Rebote (+2)', delta: 2, hitsDelta: 1, badge: '+2', color: 'blue', description: 'Acierto tras rebote (+2 pts)' },
      { id: 'triv_miss', label: '❌ Fallo (-1)', delta: -1, hitsDelta: 0, badge: '-1', color: 'red', description: 'Fallo al pulsar (-1 pt)' },
      { id: 'triv_p1', label: '🥇 1.º en Trivial (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Equipo con más preguntas acertadas' },
      { id: 'triv_p2', label: '🥈 2.º en Trivial (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Segundo clasificado en trivial' },
      { id: 'triv_p3', label: '🥉 3.º en Trivial (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Tercer clasificado en trivial' },
      { id: 'triv_p4', label: '4.º / 5.º en Trivial (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Resto de participantes' },
    ],
  },
  ...
  // 3. TELÉFONO DIBUJADO
  {
    ...
    scoringOptions: [
      { id: 'draw_exact', label: '🎯 Cadena Intacta J1 ➔ J5 (+5)', delta: 5, hitsDelta: 5, badge: '+5', color: 'amber', description: 'Lo del J1 llegó igual al J5 (+5 aciertos)' },
      { id: 'draw_best', label: '🎨 Premio Mejor Dibujo (+2)', delta: 2, hitsDelta: 2, badge: '+2', color: 'emerald', description: 'Veredicto: Mejor dibujo (+2 aciertos)' },
      { id: 'draw_worst', label: '🤪 Premio Peor Dibujo (+1)', delta: 1, hitsDelta: 1, badge: '+1', color: 'purple', description: 'Veredicto: Peor dibujo (+1 acierto)' },
      { id: 'podium_1', label: '🥇 1.º Clasificado (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Podio: Mayor puntuación (+5 pts)' },
      { id: 'podium_2', label: '🥈 2.º Clasificado (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Podio: Segundo puesto (+3 pts)' },
      { id: 'podium_3', label: '🥉 3.º Clasificado (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Podio: Tercer puesto (+2 pts)' },
      { id: 'podium_4', label: '4.º / 5.º Clasificado (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Podio: Resto de clasificados (+1 pt)' },
    ],
  },
  ...
  // 6. FOTOS PROYECTOR (BEBÉS)
  {
    ...
    scoringOptions: [
      { id: 'foto_hit', label: '👶 Foto Acertada (+2)', delta: 2, hitsDelta: 1, badge: '+2', color: 'emerald', description: 'Persona identificada (+2 pts)' },
      { id: 'foto_miss', label: '❌ Fallo (-1)', delta: -1, hitsDelta: 0, badge: '-1', color: 'red', description: 'Fallo tras pulsar (-1 pt)' },
      { id: 'foto_self', label: '🚫 Propia Foto (-2)', delta: -2, hitsDelta: 0, badge: '-2', color: 'purple', description: 'Penalización por pulsar en su propia foto (-2 pts)' },
      { id: 'foto_p1', label: '🥇 1.º en Fotos (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Equipo con más fotos acertadas' },
      { id: 'foto_p2', label: '🥈 2.º en Fotos (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Segundo clasificado en fotos' },
      { id: 'foto_p3', label: '🥉 3.º en Fotos (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Tercer clasificado en fotos' },
      { id: 'foto_p4', label: '4.º / 5.º en Fotos (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Resto de participantes' },
    ],
  },
  ...
  // 8. ADIVINA LA PELÍCULA (EMOJIS)
  {
    ...
    scoringOptions: [
      { id: 'movie_lvl1', label: '🎬 Nivel 1 (+3)', delta: 3, hitsDelta: 1, badge: '+3', color: 'amber', description: 'Acertada al primer frame (+3 pts)' },
      { id: 'movie_lvl2', label: '🎬 Nivel 2 (+2)', delta: 2, hitsDelta: 1, badge: '+2', color: 'emerald', description: 'Acertada al segundo frame (+2 pts)' },
      { id: 'movie_lvl3', label: '🎬 Nivel 3 (+1)', delta: 1, hitsDelta: 1, badge: '+1', color: 'blue', description: 'Acertada al tercer frame (+1 pt)' },
      { id: 'movie_miss', label: '❌ Fallo (-1)', delta: -1, hitsDelta: 0, badge: '-1', color: 'red', description: 'Fallo tras pulsar (-1 pt)' },
      { id: 'movie_p1', label: '🥇 1.º en Películas (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Equipo con más películas acertadas' },
      { id: 'movie_p2', label: '🥈 2.º en Películas (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Segundo clasificado cinéfilo' },
      { id: 'movie_p3', label: '🥉 3.º en Películas (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Tercer clasificado cinéfilo' },
      { id: 'movie_p4', label: '4.º / 5.º en Películas (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Resto de participantes' },
    ],
  },
  ...
  // 9. BEER PONG
  {
    ...
    description: 'Juego presencial con vasos y bolas de ping pong. Cada vaso encestado suma +1 acierto al marcador. Puntuación final al término según el Podio oficial de la prueba.',
    rules: [
    ...
    scoringOptions: [
      { id: 'bp_cup', label: '🥤 Vaso Encestado (+1)', delta: 1, hitsDelta: 1, badge: '+1', color: 'emerald', description: '+1 acierto por vaso encestado' },
      { id: 'bp_cup_undo', label: '↩️ Quitar Vaso (-1)', delta: -1, hitsDelta: -1, badge: '-1', color: 'red', description: 'Corregir vaso marcado por error' },
      { id: 'bp_1st', label: '🥇 Campeón Beer Pong (+5)', delta: 5, hitsDelta: 0, badge: '+5', color: 'amber', description: 'Equipo con más vasos encestados (+5 pts)' },
      { id: 'bp_2nd', label: '🥈 Segundo Puesto (+3)', delta: 3, hitsDelta: 0, badge: '+3', color: 'blue', description: 'Segundo clasificado (+3 pts)' },
      { id: 'bp_3rd', label: '🥉 Tercer Puesto (+2)', delta: 2, hitsDelta: 0, badge: '+2', color: 'emerald', description: 'Tercer clasificado (+2 pts)' },
      { id: 'bp_4th', label: '4.º / 5.º Puesto (+1)', delta: 1, hitsDelta: 0, badge: '+1', color: 'slate', description: 'Resto de participantes (+1 pt)' },
    ],
  },
